...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'username', 'password', 'email', 'first_name', 'last_name', 'groups', 'is_staff','is_active', 'phone_no']
        #fields ='__all__'
        extra_kwargs = {
    ...
    def to_representation(self, instance):
        ...
        # Retrieve the UserProfile's phone_no and add it to the representation
        try:
            representation['phone_no'] = instance.userprofile.phone_no
        except UserProfile.DoesNotExist:
            representation['phone_no'] = None
    ...
    def update(self, instance, validated_data):
        ...
        if phone_no is not None:
            UserProfile.objects.update_or_create(user=instance, defaults={'phone_no': phone_no})
